(function(){
  ...
  function style(){
    ...
    s.textContent=`
      ...
      .nasalHeroRule{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-top:17px}.nasalHeroRule span{background:#fff;border:1.5px solid #cfdceb;border-radius:999px;padding:9px 13px;font-size:14px;font-weight:900;color:#2e4663;box-shadow:0 1px 3px rgba(35,52,75,.04)}.nasalHeroRule i{font-style:normal;color:#7e8da0;font-weight:900}.nasalHeroNote{margin-top:13px;font-size:14px;line-height:1.7;color:#516278}
      .nasalSectionTitle{font-size:22px;font-weight:950;color:#20344d;margin:27px 0 12px;letter-spacing:-.01em}
      .nasalMouthCard{border:1px solid #dfe6ef;border-radius:18px;background:#fff;padding:16px;overflow:hidden}.nasalMapIntro{display:flex;gap:8px;align-items:baseline;flex-wrap:wrap}.nasalMapIntro b{font-size:18px;color:#25384d}.nasalMapIntro span{font-size:13px;color:#64748b}.nasalMouthSvg{width:100%;height:auto;display:block;margin-top:6px}.nasalSvgMain{font-size:26px;font-weight:950;fill:#20344d}.nasalSvgSub{font-size:13px;font-weight:700;fill:#5f6f82}.nasalSvgPair{font-size:14px;font-weight:900;fill:#2e4868}.nasalMapBottom{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}.nasalMapBottom>div{border:1px solid #e3e8ee;border-radius:11px;background:#fafcff;padding:9px}.nasalMapBottom b{display:block;font-size:14px;color:#263d56}.nasalMapBottom span{display:block;font-size:12px;color:#617186;margin-top:4px;line-height:1.5}
      .nasalPrefixPanel{border:1px solid #dfe6ef;border-radius:18px;padding:16px;background:#fff}.meNPanel{background:#f8fbff;border-color:#d7e6f6}.peNPanel{background:#fffaf5;border-color:#efdfcb}.nasalPanelHead{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:13px}.nasalPanelHead>div{display:grid;grid-template-columns:auto 1fr;gap:2px 9px;align-items:center}.nasalPanelBadge{grid-row:1/3;display:flex;align-items:center;justify-content:center;min-width:54px;height:42px;border-radius:11px;background:#fff;font-size:16px;font-weight:900}.meNPanel .nasalPanelBadge{color:#2f6fb2;border:1px solid #cfe0f4}.peNPanel .nasalPanelBadge{color:#b66b28;border:1px solid #ead5bd}.nasalPanelHead h3{margin:0;font-size:21px;color:#25384f}.nasalPanelHead small{color:#617084;font-size:13px}.nasalListenAll{border:1.5px solid #d2dde9;background:#fff;border-radius:10px;padding:9px 11px;font-size:13px;font-weight:800;color:#40556f;cursor:pointer;white-space:nowrap}
      .nasalRuleGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.nasalRuleCard{border:1px solid #e1e7ee;border-radius:14px;padding:12px;background:#fff;min-width:0}.nasalRuleTop{display:flex;align-items:center;justify-content:space-between;gap:6px}.nasalRuleTop b{font-size:17px;color:#22384f}.nasalRuleTop span{font-size:12px;border-radius:999px;padding:4px 8px;background:#eef3f8;color:#52657a;font-weight:800}.nasalRuleCard p{font-size:13px;color:#53657a;line-height:1.65;min-height:42px}.mZone{border-top:5px solid #3f7fc1;background:#f5f9ff}.nZone{border-top:5px solid #3f965c;background:#f5fbf6}.nyZone{border-top:5px solid #c28a22;background:#fffaf0}.ngZone{border-top:5px solid #7453ac;background:#faf7ff}.nasalExample{display:grid;grid-template-columns:1fr auto 1.15fr auto;gap:7px;align-items:center;padding:9px 0;border-top:1px solid #e5eaf0;font-size:13px}.nasalExample:first-of-type{border-top:0}.nasalExample span{color:#5d6d81;font-weight:700}.nasalExample i{font-style:normal;color:#8794a3;font-weight:900}.nasalExample b{font-size:14px;color:#1f354d}.nasalExample button,.nasalMirrorCard>button{border:1.5px solid #d8e1ea;background:#fff;border-radius:8px;cursor:pointer;font-size:12px;padding:5px 7px}
      .nasalSpecialRow{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:10px}.nasalSpecialRow>div{background:#fff;border:1px dashed #dbe3ec;border-radius:12px;padding:10px}.nasalSpecialRow b{font-size:14px;color:#2d4158}.nasalSpecialRow span{display:block;font-size:12px;color:#66758a;margin-top:3px}.nasalSpecialRow small{display:block;font-size:13px;color:#40536b;margin-top:7px;line-height:1.6}.nasalSurfaceNote{margin-top:12px;padding:12px 13px;border-radius:12px;background:#fff;border:1.5px solid #d6e1ec;font-size:13px;line-height:1.65;color:#4f6075}.nasalSurfaceNote b{color:#245b96}
