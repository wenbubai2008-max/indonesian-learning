(function(){
  ...
  function style(){
    ...
    s.textContent=`
      ...
      .nasalRuleGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.nasalRuleCard{border:1.5px solid #d8e2ec;border-radius:16px;padding:16px;background:#fff;min-width:0;box-shadow:0 2px 8px rgba(34,53,75,.035)}.nasalRuleTop{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px}.nasalRuleTop b{font-size:20px;color:#172b42;font-weight:950;letter-spacing:-.01em;white-space:nowrap}.nasalRuleTop span{font-size:13px;border-radius:999px;padding:5px 10px;background:#e8eef5;color:#3e536b;font-weight:900;white-space:nowrap;line-height:1.2}.nasalRuleCard p{font-size:15px;color:#334a63;line-height:1.7;min-height:50px;font-weight:650}.mZone{border-top:6px solid #2f73bd;background:#f1f7ff}.nZone{border-top:6px solid #2f8d51;background:#f1faf4}.nyZone{border-top:6px solid #bc7d14;background:#fff7e8}.ngZone{border-top:6px solid #6d4ca8;background:#f7f2ff}.nasalExample{display:grid;grid-template-columns:max-content 18px max-content;grid-template-rows:auto auto;column-gap:8px;row-gap:5px;align-items:center;justify-content:start;padding:12px 0;border-top:1px solid #dce4ec;font-size:15px;min-width:0}.nasalExample:first-of-type{border-top:0}.nasalExample span{grid-column:1;grid-row:1;color:#314861;font-weight:800;white-space:nowrap}.nasalExample i{grid-column:2;grid-row:1;font-style:normal;color:#6d7f92;font-weight:950;font-size:17px;text-align:center}.nasalExample b{grid-column:3;grid-row:1;font-size:16px;color:#152b43;font-weight:950;white-space:nowrap}.nasalExample button{grid-column:3;grid-row:2;justify-self:end;position:static;transform:none;border:1.5px solid #cfd9e4;background:#fff;border-radius:8px;cursor:pointer;font-size:11px;padding:0;width:28px;height:28px;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;margin-top:-1px}.nasalMirrorCard>button{border:1.5px solid #cfd9e4;background:#fff;border-radius:9px;cursor:pointer;font-size:12px;padding:6px 8px}
