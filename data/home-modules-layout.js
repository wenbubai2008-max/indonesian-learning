(function(){
  ...
  function style(){
    ...
    s.textContent=`
      ...
      .nasalRuleGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.nasalRuleCard{border:1.5px solid #d8e2ec;border-radius:16px;padding:16px;background:#fff;min-width:0;box-shadow:0 2px 8px rgba(34,53,75,.035)}.nasalRuleTop{display:flex;align-items:center;justify-content:space-between;gap:6px}.nasalRuleTop b{font-size:20px;color:#172b42;font-weight:950;letter-spacing:-.01em}.nasalRuleTop span{font-size:13px;border-radius:999px;padding:5px 9px;background:#e8eef5;color:#3e536b;font-weight:900}.nasalRuleCard p{font-size:15px;color:#334a63;line-height:1.7;min-height:50px;font-weight:650}.mZone{border-top:6px solid #2f73bd;background:#f1f7ff}.nZone{border-top:6px solid #2f8d51;background:#f1faf4}.nyZone{border-top:6px solid #bc7d14;background:#fff7e8}.ngZone{border-top:6px solid #6d4ca8;background:#f7f2ff}.nasalExample{display:grid;grid-template-columns:1fr auto 1.2fr auto;gap:9px;align-items:center;padding:12px 0;border-top:1px solid #dce4ec;font-size:15px}.nasalExample:first-of-type{border-top:0}.nasalExample span{color:#314861;font-weight:800}.nasalExample i{font-style:normal;color:#6d7f92;font-weight:950;font-size:17px}.nasalExample b{font-size:17px;color:#152b43;font-weight:950}.nasalExample button,.nasalMirrorCard>button{border:1.5px solid #cfd9e4;background:#fff;border-radius:9px;cursor:pointer;font-size:13px;padding:7px 8px}
