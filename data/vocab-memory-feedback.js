(function(){
  ...
  async function boot(){
    try{
      ...
      await load('data/vocab-upgrade-gz-01.js?v=20260913-stable7');
      await load('data/vocab-upgrade-gz-02.js?v=20260913-stable7');
      ...
      await load(url);
      await load('data/vocab-bipa-stable-20260913.js?v=20260913-stable7');
      await load('data/vocab-bipa-progress-fix-20260913.js?v=20260913-stable7');
      await load('data/vocab-bipa-final-20260913.js?v=20260913-stable7');
...
(function(){
  ...
  var s=document.createElement('script');s.src='data/master-top1000-weak-merge.js?v=20260913-stable7';s.dataset.masterTop1000WeakMerge='1';document.head.appendChild(s);
})();