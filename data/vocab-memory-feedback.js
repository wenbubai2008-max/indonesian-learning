(function(){
  ...
  async function boot(){
    try{
      ...
      await load('data/vocab-upgrade-gz-01.js?v=20260917-finalcard6');
      await load('data/vocab-upgrade-gz-02.js?v=20260917-finalcard6');
      ...
      await load('data/vocab-bipa-final-20260913.js?v=20260917-finalcard6');
      await load('data/vocab-bipa-toolbar-compact-20260917.js?v=20260917-finalcard6');
      await load('data/vocab-bipa-flip-layout-fix-20260913.js?v=20260917-finalcard6');
