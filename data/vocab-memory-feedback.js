(function(){
  ...
  async function boot(){
    try{
      ...
      await load('data/vocab-upgrade-gz-01.js?v=20260913-1');
      await load('data/vocab-upgrade-gz-02.js?v=20260913-1');
      ...
      await load('data/vocab-final-hotfix-20260913.js?v=20260913-1');
...
(function(){
  ...
  var s=document.createElement('script');s.src='data/master-top1000-weak-merge.js?v=20260913-1';s.dataset.masterTop1000WeakMerge='1';document.head.appendChild(s);
})();