(function(){
  ...
  async function boot(){
    try{
      ...
      await load('data/vocab-upgrade-gz-01.js?v=20260917-unified-ui1');
      await load('data/vocab-upgrade-gz-02.js?v=20260917-unified-ui1');
      ...
      await load('data/vocab-bipa-final-20260913.js?v=20260917-unified-ui1');
      await load('data/vocab-bipa-toolbar-compact-20260917.js?v=20260917-unified-ui1');
      await load('data/vocab-bipa-flip-layout-fix-20260913.js?v=20260917-unified-ui1');

      /*
       * 必须最后加载：所有词库、已掌握、待掌握、筛选、BIPA S/A/B
       * 最终都只允许这一套 renderer 输出卡片，禁止旧 flash/cleanFlash/bipaV7Card 回流。
       */
      await load('data/vocab-unified-renderer-20260917.js?v=20260917-unified-ui1');
